...
| **Third Eye** | 5 | The Seeker's Eye, looking through walls: close the inventory with a search still typed and every container in the 3×3×3 chunks around you (your chunk and its ring, one layer up and one down) holding a match glows through everything for ten seconds — chests, placed shulkers, furnaces, hoppers — each outlined in its own block shape. The height cut is deliberate: it confirms your own storage, it does not read the dungeon under the floor |
