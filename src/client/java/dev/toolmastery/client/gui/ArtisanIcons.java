...
public final class ArtisanIcons {
	...
	/** Artisan's Order, {@link dev.toolmastery.storage.SortMode#CATEGORY}: a grid of bins. */
	...
	/** Artisan's Order, {@link dev.toolmastery.storage.SortMode#COUNT}: a rising bar chart. */
