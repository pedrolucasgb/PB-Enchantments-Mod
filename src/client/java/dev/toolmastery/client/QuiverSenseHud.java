...
public final class QuiverSenseHud {
	private static final Identifier ID = Identifier.fromNamespaceAndPath(ToolMastery.MOD_ID, "quiver_sense");
	...
	private static void draw(net.minecraft.client.gui.GuiGraphicsExtractor graphics) {
		...
		String text = ammo.isEmpty()
			? Component.translatable("perk.toolmastery.quiver_sense.empty").getString()
